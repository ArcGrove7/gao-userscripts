// ==UserScript==
// @name         Gun Art Online Eye-Care + Item Classifier (Optimized)
// @namespace    gunart-lowsat-classify
// @version      3.2.0
// @description  Low-saturation eye-care theme + API-driven item classifier (optimized for performance)
// @author       ArcGrove
...
/* Changelog
 * 3.2.0 - Performance optimization: reduced DOM reflows, optimized array operations,
 *         debounced storage writes, cached filter lookups, single unified MutationObserver
 */
...
/* ============================================================
 * Module 2/2: API-driven item classifier (OPTIMIZED)
 * ============================================================ */
(function () {
  'use strict';
